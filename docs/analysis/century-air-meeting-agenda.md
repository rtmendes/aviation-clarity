...
| C5 | If a lesson finishes early, can I keep the aircraft for the remainder of the block as solo practice? | Converts leftover block time into logged hours instead of wasted reservation. | A standing arrangement rather than a per-flight negotiation. | — |
| C6 | What happens to my block if the aircraft goes unserviceable that morning — do I get priority on another airframe? | Determines whether a maintenance surprise costs me a lesson or just an airplane. | Priority re-assignment for students on a standing schedule. | HIGH |
