# Century Air — Meeting Agenda and Open Questions
...
**Decided and not up for discussion:** the simulator is not central to the plan — the
2.5-hour device credit Part 61 allows (14 CFR 61.109(k)) is fine, so no AATD/BATD questions
below.

Priority key: **MUST** = do not leave without it · **HIGH** = materially affects budget or
schedule · standard = worth asking if there's time.


## Answers to the four questions you already raised

| Question | Where it stands | What to push for |
| --- | --- | --- |
...
## What is actually in the $650 private pilot kit

Itemised from the brochure (p. 5). Note first that your **headset, foggles, flashlights and
flight bag are not in the kit at all** — the brochure lists headsets separately as a
recommendation — so owning those does not reduce the $650. What overlaps is the books, the
online course and the small navigation items.

Five things in the kit are school- or aircraft-specific and you should *want* them. Two are
Part 141 course artifacts you may not need at all on Part 61. That makes the ask precise:
**itemise the kit and charge me only for what I can't supply**, rather than waive-or-pay-$650.

| Item | What it is | Can you substitute your own? |
| --- | --- | --- |
| Jeppesen Private Pilot Manual | The school's primary textbook. | **Yes — substitute** — Yes — you have your own books and Sporty's. |
| Jeppesen FAR/AIM | Regulations and the Aeronautical Information Manual. | **Yes — substitute** — Yes — any current FAR/AIM, or the free online eCFR and AIM. |
...
| Aircraft Checklist | Century Air's checklist for their aircraft. | **No — take theirs** — No — use the school's, it matches how they teach and how their airplanes are equipped. |
...
20–30 minutes after (secure, debrief, logbook) around whatever the Hobbs records:

| Lesson type | Block to reserve | Hobbs you should expect |
| --- | --- | --- |
| Pattern work, takeoffs and landings | 2 hours | 1.0 – 1.3 |
| **Standard lesson — maneuvers, most of the course** | **3 hours** | **1.5 – 2.0** |
| Dual then solo, back to back, same aircraft | 4 hours | 1.5 dual + 1.0 solo |
| Dual cross-country | 4 – 5 hours | 2.5 – 3.5 |
...
3. **Combine dual and solo in one block.** I owe 15 solo hours; doing 1.5 dual then 1.0 solo in
   a single 4-hour reservation saves a second preflight, a second trip to the airport, and puts
   the instructor on hand to debrief both.
4. **Claim the remainder of a block.** If a lesson ends early, keep the aircraft for solo
   practice rather than handing back paid-for reservation time.


## A. Billing mechanics — the biggest unknowns in the budget

| # | Question | Why it matters | What to push for | Priority |
| --- | --- | --- | --- | --- |
| A1 | Do you bill Hobbs time or tach time, and does the billed number equal the time I log? | The single largest unquantified item. Tach time typically runs below Hobbs on a trainer, so the same 50 logged hours can differ by 10–15% on the invoice — roughly $1,300–$1,900 of aircraft time. | A clear answer in writing. If it's Hobbs, ask whether taxi time is included. If tach, confirm the FAA logbook time I record is the block time, not the billed tach. | **MUST** |
| A2 | Are pre- and post-flight briefings billed as ground instruction? At what rate, and typically how long per lesson? | At $86/hr and 0.3–0.5 hr per lesson, 34 lessons is 10–17 hours = $860–$1,460. This decides whether my ground line is 8 hours or 25. | A per-lesson norm. Ask whether briefings can be bundled or shortened once I'm self-studying with Sporty's. | **MUST** |
| A3 | Confirm my Part 61 hourly rates: $282 dual, $196 solo, $86 ground — the brochure prices Part 141 packages. | Every figure in my budget is derived from those three numbers. If Part 61 bills differently, the whole plan moves. | The three rates confirmed in writing for Part 61, plus whatever the 172N rents for. | **MUST** |
| A4 | What does the 172N rent for? It's in your fleet but not in the brochure. | Same 160 hp airframe class as the 172P. If it's cheaper it becomes my primary trainer. | A rate, and whether it's available as much as the 172P. | HIGH |
| A5 | Is a fuel surcharge in effect right now? What triggers it and how is it calculated? | The brochure says a surcharge may be added based on the fuel price at KCDW. Unpriced, and it applies to every hour. | Current status, the $/gal trigger, and the formula — so I can model it. | HIGH |
| A6 | What does the $150 'applicable tax' line cover? If it's sales tax on the materials kit, does it go away with the kit? | Small but it's in the printed package and I'm waiving the kit. | A yes/no. | — |
| A7 | I already own all the books, a headset, foggles, flashlights and a flight bag. Can the $650 kit be waived? | $650 straight off the invoice. The brochure lists buying the kit as an enrollment requirement — I suspect that's a Part 141 course condition. | Waived, or itemized so I only buy what I actually lack (e.g. the school's syllabus and checklists). | **MUST** |
| A8 | Is there a discount for prepaying block time? What size block, what discount, and does it expire? | Typical block discounts are a few percent — on ~$12,800 of flying that's real money. | The discount tiers and any expiry date. | HIGH |
| A9 | If I prepay and then relocate to Texas mid-course, is the unused balance refundable? | I am moving to Denton. Unrefundable prepaid credit is a straight loss, and it can outweigh any block discount. | A written refund term. If it's non-refundable, prepay only in small increments. | **MUST** |
| A10 | What deposit do you need to enroll, and is it refundable? | The brochure mentions $1,800 payment increments. I need to know what's at risk on day one. | Amount and refund terms. | HIGH |
...
| # | Question | Why it matters | What to push for | Priority |
| --- | --- | --- | --- | --- |
| C1 | Are 3-hour reservation blocks the right default, and can I get longer blocks for cross-country days? | A 3-hour block yields about 1.5–2.0 hours on the Hobbs after preflight, brief and debrief. Pattern lessons need less; cross-countries need 4–5 hours; the long solo needs most of a day. | 3 hours for standard lessons, 2 for pattern work, 4–5 for cross-countries, a half day for the 150 NM. | HIGH |
| C2 | Can I book a 4-hour block as dual plus solo back-to-back in the same aircraft? | I owe 15 solo hours. Doing 1.5 dual then 1.0 solo in one reservation saves a second preflight, a second commute and a second slot — and the instructor is on hand to endorse and debrief. | Agreement to structure blocks this way once I'm solo-endorsed. | HIGH |
| C3 | If a lesson finishes early, can I keep the aircraft for the remainder of the block as solo practice? | Converts leftover block time into logged hours instead of wasted reservation. | A standing arrangement rather than a per-flight negotiation. | — |
| C4 | What happens to my block if the aircraft goes unserviceable that morning — do I get priority on another airframe? | Determines whether a maintenance surprise costs me a lesson or just an airplane. | Priority re-assignment for students on a standing schedule. | HIGH |

## D. Instructor — the biggest single variable in how fast I finish
...
| # | Question | Why it matters | What to push for | Priority |
| --- | --- | --- | --- | --- |
| F1 | Which of your aircraft have an IFR-approved WAAS GPS? | The instrument rating requires three different kinds of approaches (61.65(d)(2)(ii)), which in practice means an RNAV (GPS) approach. This determines which airplane I can finish the rating in. | A per-tail-number answer. | HIGH |
| F2 | Which autopilot is in the 172SP NAV III — GFC 700 or KAP 140? And do any of the analog 172s have one? | The 61.129(j) technically-advanced-airplane definition requires a two-axis autopilot integrated with navigation and heading. It matters for the commercial 10-hour requirement later. | The specific model. | — |
| F3 | Is an EGT gauge fitted to the 172N or 172P? | It changes how I'm taught to lean. Without one it's lean-to-peak-RPM by feel; with one it's a measurement. | Yes or no per aircraft. | — |
| F4 | Will my own headset work with the intercom, and do you have a spare if mine fails? | A dead headset shouldn't cost me a lesson. | Confirmation and a loaner. | — |
| F5 | Can I sit in the two candidate airplanes today and see their condition? | Cabin condition, seat and rudder-pedal fit, and panel layout all affect whether I'll actually enjoy 50 hours in there. | Ten minutes on the ramp. | HIGH |

## G. Part 61 process, endorsements and the school's own rules

| # | Question | Why it matters | What to push for | Priority |
| --- | --- | --- | --- | --- |
| G1 | Under Part 61, do you still run the three stage checks, and are they billed as dual or ground? | The brochure describes three stage checks in the Part 141 course. If they carry over to Part 61 they are hours I haven't budgeted. | Whether they apply, and how they're billed. | HIGH |
| G2 | As a Part 61 student, do I still get the syllabus, progress chart and stage exams? | I want the structure without the Part 141 course obligations. | Access to the syllabus materials. | HIGH |
| G3 | Who signs my pre-solo written exam and my endorsements, and how quickly? | 61.87(b) requires the instructor to administer, grade and review the pre-solo test. A slow endorsement chain stalls the schedule. | Same-week turnaround. | HIGH |
| G4 | What are the school's own solo minimums — wind, ceiling, visibility — beyond the FAA's? How often do solos actually get cancelled? | School minimums, not FAA minimums, are what will cancel my solo flights. This directly sets my attrition rate and therefore my finish date. | The actual numbers, and an honest cancellation rate. | **MUST** |
| G5 | What's the approval process for a solo cross-country, and how far ahead do routes need to be approved? | 61.93 requires the instructor to review my planning. If that needs 48 hours' notice, I plan around it. | The notice period and who approves. | HIGH |
| G6 | Anything else required before solo beyond the FAA's requirements? | I've budgeted the FAA list; I don't want to discover a school-specific one in October. | A complete list. | HIGH |

## H. Insurance

| # | Question | Why it matters | What to push for | Priority |
| --- | --- | --- | --- | --- |
| H1 | What non-owned renter's limits do you require, and what hull deductible am I responsible for? | The brochure says $750–900 a year for a policy. The deductible is the part nobody mentions — it can be thousands out of pocket after a prop strike or a hard landing. | The required limits and the deductible amount, in writing, so I can buy the right policy rather than the cheapest. | **MUST** |
| H2 | Do you have preferred insurers, and does Century Air need to be a named insured? | Getting this wrong means buying the policy twice. | The exact wording your policy needs. | HIGH |
| H3 | Is there a school-provided or group option, and is it cheaper than AOPA/Avemco/EAA? | Might beat the $750–900 estimate. | A quote to compare. | — |

## I. Checkride logistics
...
| I5 | If a checkride is discontinued, what does the partial retest cost in aircraft time and examiner fee? | So the contingency is budgeted rather than a surprise. | Both numbers. | HIGH |
| I6 | Do you offer a mock checkride, and is it billed as dual or ground? | The highest-value few hours in the whole course if it's with someone who knows the examiner. | Availability and rate. | HIGH |

## J. The move to Denton and the instrument phase
...
- Photo ID and proof of U.S. citizenship — passport, or birth certificate plus government photo ID (the brochure requires this at enrollment)
- First-class medical certificate
- FAA private pilot written test report, if the test is done before the meeting
- Logbook, if any time is already logged
- This checklist, and something to write the numbers on

## What to leave with — the ten answers that matter

1. Part 61 hourly rates in writing: dual, solo, ground — and the 172N's rate
2. A written answer on Hobbs vs tach billing
3. The standing weekly reservation pattern, in writing, with a start date
4. A named primary aircraft, a named backup, and a named instructor
5. Whether briefings are billable, and the typical minutes per lesson
6. Whether the $650 kit is waived
7. Insurance limits and the hull deductible
8. The examiner's name, lead time and fee
9. Block-time discount terms and the refund policy if I relocate
10. A ForeFlight answer: school licence, or buy my own

## Your negotiating position

Worth being aware of, because it's stronger than a typical walk-in student's:

| What you bring | Why it's leverage |
| --- | --- |
...
- [14 CFR 61.109 — private pilot experience, incl. (k) device credit](https://www.law.cornell.edu/cfr/text/14/61.109)
- [14 CFR 61.87 — pre-solo requirements](https://www.law.cornell.edu/cfr/text/14/61.87)
- [14 CFR 61.93 — solo cross-country requirements](https://www.law.cornell.edu/cfr/text/14/61.93)
- [14 CFR 61.65 — instrument rating requirements](https://www.law.cornell.edu/cfr/text/14/61.65)
- [14 CFR 61.129 — commercial experience and the TAA definition](https://www.law.cornell.edu/cfr/text/14/61.129)
- [ForeFlight plans and pricing](https://foreflight.com/pricing/)
- [ForeFlight for education and flight training](https://foreflight.com/solutions/education/)
- [Century Air — aircraft rental fleet](https://centuryair.com/aircraft-rental/)
- Century Air Private Pilot brochure (© 2025), pp. 3–6
- Companion documents: `cessna-172-g1000-cost-benefit.md`, `ppl-to-instrument-training-plan.md`

*Prices and rates referenced are from Century Air's published brochure or derived from it, and
from ForeFlight's public pricing page as of 8 September 2026. Everything in this list is a
question precisely because it is not yet confirmed.*
