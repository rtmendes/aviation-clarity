...
SECTIONS = [
 ...
 ("D", "Cadence — the reason I am choosing you", [
  ("d1", "Book the standing pattern now — six days a week with doubles on two — through 30 November.",
   "RESOLVED at dispatch: the Pipistrel schedules out through December and the slots are there. Weekday mornings are the low-contention window; weekends and after-work are where everyone competes. This is no longer a question, it is a task — and availability seen today is not availability held tomorrow.",
   "Slots actually in the system, not an intention. Book past the 31 October target so weather has somewhere to go; you can give slots back, but you cannot invent them in November.", "must"),
  ("d2", "Confirm one instructor can carry 8–9 slots a week for you, now that the aircraft side is settled.",
   "Aircraft availability is resolved — three Alpha Trainers, schedulable through December. The instructor is the remaining half of the same question, and it is the half a scheduling screen does not answer.",
   "A named instructor whose own calendar shows those slots, not just an aircraft that is free.", "must"),
  ("d3", "Confirm the 07:00 weekday slot is yours as a standing booking.",
   "RESOLVED in principle: weekday mornings are the least contended window, which is exactly the slot the cadence plan wants. Calm air, fewest cancellations, and no delay inherited from an earlier flight.",
   "The early slot booked as a repeating reservation rather than claimed each week.", "high"),
  ...
  ("d6", "What is the cancellation and no-show policy, and how late can I cancel for weather?",
   "This matters MORE now that the schedule is bookable far out. The plan deliberately books a sixth day as a weather buffer and books past the target date as insurance — so you will cancel slots by design, possibly dozens of them. A per-cancellation fee turns a sensible buffer into a recurring charge. Twenty cancelled slots at even $25 is $500.",
   "A weather carve-out with a same-morning window, and written confirmation that giving back a standing-reservation slot with reasonable notice is free.", "must")
 ]),
 ...
 ("F", "The instrument phase — where the real money is", [
  ...
  ("f4", "Does your Part 141 instrument course list the Pipistrel as an approved aircraft — may I see the course document?",
   "This one question settles whether the Alpha Trainer can carry the instrument rating. Your courses are per-aircraft: the sheet shows separate C172S and PIAT private courses, so the instrument course names aircraft too. If the Pipistrel is on it, the 4-hour 172 transition comes out of the budget and the aircraft carries the whole plan. If not, the instrument phase moves to a 172S at $345/hr dual.",
   "The course document, not an opinion.", "must"),
  ("f5", "What do that airframe's FAA operating limitations say about IFR?",
   "The POH permits IFR in VMC conditions only, and the manufacturer's handbook is not the authority anyway — the individual aircraft's FAA operating limitations document is. An instrument rating in an aircraft that may never legally enter cloud is a strange thing, and worth understanding before committing to it.",
   "Sight of the operating limitations for the specific tail number.", "high"),
  ("f6", "Is it equipped for IFR — an approved navigator for three kinds of approaches, and current pitot-static and transponder checks?",
   "Appendix C requires three different kinds of approaches, which needs an IFR-approved navigator. 91.411 and 91.413 require the pitot-static system and transponder to have been checked within the preceding 24 calendar months. The POH's minimum equipment list leaves VHF COM/NAV unmarked even in its IFR column, so it tells you nothing.",
